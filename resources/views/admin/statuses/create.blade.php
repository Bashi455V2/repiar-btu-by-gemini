                ...
                <div class="p-6 sm:p-8">
                    <form method="POST" action="{{ route('admin.statuses.store') }}">
                        ...
                        <div class="mt-4">
                            ...
                            <x-text-input id="color_class" name="color_class" type="text" class="mt-1 block w-full border-slate-300 dark:border-slate-600 focus:border-sky-500 dark:focus:border-sky-600 focus:ring-sky-500 dark:focus:ring-sky-600 rounded-md shadow-sm bg-white dark:bg-slate-700 text-slate-700 dark:text-slate-200" :value="old('color_class')" placeholder="เช่น bg-sky-100 text-sky-800 dark:bg-sky-700 dark:text-sky-100" />
